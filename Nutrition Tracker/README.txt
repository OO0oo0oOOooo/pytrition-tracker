...
4. Press Calc Nutrition to add all food items "C:number" to total.


Edit Template.txt to control how new files will generate.

This is just a quick solution to save me from writing and adding everything up.
